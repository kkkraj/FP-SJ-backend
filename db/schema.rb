...
ActiveRecord::Schema.define(version: 2025_09_08_022807) do
  ...
  create_table "user_goals", force: :cascade do |t|
    ...
    t.index ["date"], name: "index_user_goals_on_date"
    t.index ["goal_id"], name: "index_user_goals_on_goal_id"
    t.index ["user_id", "date"], name: "index_user_goals_on_user_id_and_date"
